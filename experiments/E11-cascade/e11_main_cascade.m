...
%
% Νικοσ: new cex are added not eliminated. unclear why
...
model=11; % 1: watertank, 2: robotarm, 3: quadcopter

if model==11
    SLX_model='e11_cascade';
end
...
training_options.neurons=[60 20 ];
...
if model==11
    options.ref_Ts=20;             %tank_reactor
    options.sim_ref=1.2;
    options.ref_min=0;
    options.ref_max=2;
...
%             training_options.neurons=[30 30 30]
        ...
        %
        options.input_choice=3
        num_cex=15;options.plotting_sim=1;
