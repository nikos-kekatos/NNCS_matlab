...
options.model=4;
load('e4_PIDGainSchedExample.mat')
options.num_REF=1;
options.num_U=1;
options.num_Y=1;
...
options.specs_file='e4_specs_tank.stl';
% added for Breach
try
...
if options.reference_type==4
    ...
    options.sim_cov=0;
    options.sim_ref=0;
    options.no_traces=40;
    options.breach_ref_min=6;
    options.breach_ref_max=7;
