...
P=-1000/(s*(s+.875)*(s+50));
[numP,denP]=tfdata(P);
[num1,den1,num2,den2,numP,denP]=deal(num1{1},den1{1},num2{1},den2{1},numP{1},denP{1});
...
if options.reference_type==3
    ...
    options.ref_Ts=options.T_train/options.coverage.m;
    options.coverage.ref_min=0; % o
    options.coverage.ref_max=1; % 0.3
    options.coverage.delta_resolution=1/6; %0.1
