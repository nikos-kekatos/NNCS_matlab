...
% validationOutput=permute(validationOutput,[3,2,1,4]);
% testDataOutput=permute(testDataOutput,[3,2,1,4]);

% Train Network
imitateMPCNetObj = trainNetwork(trainInput,permute(trainOutput,[3,2,1,4]),imitateMPCNetwork,options);
