...
options.T_train=5; % for constant choose 5s
...
options.specs_file='specs_robotarm.stl';
% added for Breach
try
...
if options.reference_type==3
    ...
    options.coverage.delta_resolution= 1/4 % paper1/7;
