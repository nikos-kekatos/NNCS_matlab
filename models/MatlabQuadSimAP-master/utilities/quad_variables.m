...
% PID parameters
Quad.X_KP = .1;          % KP value in X position control
Quad.X_KI = 0;            % KI value in X position control
Quad.X_KD = -0.1;         % KD value in X position control
Quad.X_KI_lim = .25;         % Error to start calculating integral term

Quad.Y_KP = .1;          % KP value in Y position control
Quad.Y_KI = 0;            % KI value in Y position control
Quad.Y_KD = -0.1;         % KD value in Y position control
Quad.Y_KI_lim = .25;         % Error to start calculating integral term

Quad.Z_KP = 4;    % KP value in altitude control
Quad.Z_KI = 0;    % KI value in altitude control
Quad.Z_KD = -4;  % KD value in altitude control
...
Quad.q_KI = 0;     % KI value in pitch control
