...
% training_options.neurons=[10 10 10 ];
...
file_name='Quadrotor_two_blocks';
...
run_simulation_nncs(options,file_name,4);
...
while i_f<=falsif.iterations_max && ~stop
    ...
    %
    if stop~=1
        for tm = 2%[2 3 1] % or we choose the preference/order
            timer_retrain=tic;
