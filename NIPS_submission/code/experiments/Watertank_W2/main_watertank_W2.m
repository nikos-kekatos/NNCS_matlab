...
timer.trace_gen=timerTrace_gen;
timer.train=timerTrain;
...
options.sim_ref=8;               % robotarm
options.ref_min=8.5;
options.ref_max=11.5;
options.sim_cov=[8.7;11.8;10.12;9/5];
