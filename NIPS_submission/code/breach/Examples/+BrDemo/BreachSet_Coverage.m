...
% 
profile on
[covocc3, covlog3, covent3 ] = BrDemo.compute_batch_coverage_moved(B3, il, epsi, delta); 
profile report
%%
%
[covocc6, covlog6, covent6 ] = BrDemo.compute_batch_coverage_moved(B6, il, epsi, delta); 

%%
%
[covocc9, covlog9, covent9 ] = BrDemo.compute_batch_coverage_moved(B9, il, epsi, delta); 
...
[covocc, covlog] = BrDemo.compute_batch_coverage_moved(B9, il, epsi, delta); 
