...
elseif strcmp(model_name,'quadcopter')|| strcmp(model_name,'quadcopter_NN')
    ...
    var_names_list={};
    model_type=2;
elseif strcmp(model_name,'robotarm')||strcmp(model_name,'robotarm_NN') ||strcmp(model_name,'robotarm_NN_cex')||strcmp(model_name,'robotarm_A11') || strcmp(model_name,'robotarm_A12')||strcmp(model_name,'robotarm_A2')
    var_names_list={};
    model_type=3;
